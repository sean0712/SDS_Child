...
public class PostHomework implements Serializable {
    String homework; // 과제명
    ...
    public PostHomework(String homework, String date) {
        this.homework = homework;
        this.date = date;
    }

    public PostHomework(String homework, String date, boolean sub1, boolean sub2, boolean sub3, boolean sub4, boolean sub5, boolean sub6, boolean sub7, boolean sub8, boolean sub9, boolean sub10, boolean sub11, boolean sub12, boolean sub13, boolean sub14, boolean sub15, boolean ret1, boolean ret2, boolean ret3, boolean ret4, boolean ret5, boolean ret6, boolean ret7, boolean ret8, boolean ret9, boolean ret10, boolean ret11, boolean ret12, boolean ret13, boolean ret14, boolean ret15) {
        this.homework = homework;
        this.date = date;
        this.sub1 = sub1;
        this.sub2 = sub2;
        ...
        this.sub15 = sub15;
        this.ret1 = ret1;
        this.ret2 = ret2;// 파이어베이스에서 가져온 과제명과 날짜 활용할 때 사용
        this.ret3 = ret3;
        this.ret4 = ret4;
        this.ret5 = ret5;
        this.ret6 = ret6;
    ...
    public PostHomework(String homework, String date, boolean sub1, boolean ret1) {
        this.homework = homework;
        this.date = date;
        this.sub1 = sub1;
        this.ret1 = ret1;
